	...
	stages {
		...
		stage('Build Docker Image')
				...
				sh 'sudo chmod 666 /var/run/docker.sock'
                                sh 'docker build -t mstone9/csc324flaskapp:$VERSION .'
                                sh 'docker build -t mstone9/csc324flaskapp:latest .'
                        }
                }
		...
		stage('Push Image to Dockerhub') {
			...
			steps {
				sh 'docker push mstone9/csc324flaskapp:$VERSION'
				sh 'docker push mstone9/csc324flaskapp:latest'
			}
		}
